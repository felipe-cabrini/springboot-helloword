...
- Ir a los archivos .feature (src>test>resources>br.com.aula.one) agregar tus escenarios, metodos de prueba, aserciones, y todo lo necesario para tus pruebas en particular
- Ir a los runners de prueba (src>test>java>br.com.aula.one) y agregar en Runner.path(nombre del feature a probar)
